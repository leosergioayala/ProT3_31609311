 ...
 <form class="row g-3 menu">
  ...
  <div class="col-12">
    ...
    <input type="text" class="form-control" id="inputUser" placeholder="Usuario (Puede contener números y signos)">
  </div>
  <div class="col-md-6 ">
  ...
  <div class="col-md-6">
    ...
    <input type="password" class="form-control" id="inputPassword" placeholder="contraseña (mínimo 5 caracteres)">
  </div>
